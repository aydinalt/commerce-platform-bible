...
| Current phase | M12 Increment I23 Error Behaviour — closed for the public path. Twenty-four increments, I0 through I23. Eight Frozen UX documents specify Error Behaviour and the web application implemented none of it; the Owner scoped this increment to the mechanism plus UX-0001 §13 and UX-0002 §14, leaving six documents queued. R1.2, R1.4 and all of R2 of `docs/releases/V1_RELEASE_CRITERIA_CANDIDATE.md` need a hosting target and a monitoring system, neither of which exists |
