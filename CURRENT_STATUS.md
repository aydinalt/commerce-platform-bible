...
| Current phase | M12 Increment I22 Database Outage — closed. Twenty-three increments, I0 through I22. This is R3.6's behaviour; its evidence still needs an environment to fail in. R1.2, R1.4 and all of R2 of `docs/releases/V1_RELEASE_CRITERIA_CANDIDATE.md` need a hosting target and a monitoring system, neither of which exists |
