...
> **Candidate Status (1.2):** **controlled revision candidate** under
> `DOCUMENT_LIFECYCLE.md` §7–§8. Frozen v1.1 remains authoritative and is
> untouched at `US-DSC-F06-001-discovery-results-and-listing-cards.md`. Nothing
> here is authoritative until the Owner approves and Freezes it.
>
> **This candidate is meant to be approved together with `PRD-0002-discovery.md`
> v3.1**, because v3.1's §22.3 points at this Story for the depth bound and this
> Story's AC-13 would otherwise state a number no approved PRD sends it.
>
