...
> **Freeze Note (2.3):** Explicitly Frozen by the Product Owner /
...
> §20 now admits a fourth advertising region the platform serves itself, bounded exactly as the three it already permitted. The exclusions of paid placement, sponsored priority, promoted Listing Cards and Business-controlled ranking are unchanged.
...
> been taken.** Frozen v2.2 remains the baseline and is preserved unchanged at
> `PRD-0006-platform.md` until this revision is reviewed, Approved and, if the
> Owner chooses, Frozen.
>
> **One change: §20 admits a second kind of advertising — one the platform
> serves itself — and bounds it exactly as the first is bounded.**
>
> The Owner's requirement is recorded in his own words: _"Favorilere ekle,
> Karşılaştır, Paylaş bölümünün hemen altında bir reklam niteliği taşıyan
> yönlendirme bölümü vardı… otomotiv ile ilgili ilan incelendiğinde belirttiğim
> yerde lastik affilte link yönlendirmesi olması gerekiyor. Tüm ilan
> bölümlerinde ilgili bölüme uygun tamamlayıcı ürünler önermesi gerekiyor."_
>
> **Why v2.2 does not already cover it.** §20 was written for an external
> network: it names a publisher identifier, unit identifiers and a network that
> sells, moderates and reports. A complementary-product link is none of those.
> It is a row somebody at this platform wrote — a label, a partner and an
> address — served by the platform, from its own arrangement with that partner.
> Reading it into §20 as written would mean either calling it a "unit" of a
> network that is not involved, or calling it something other than advertising,
> and it is advertising: it is paid placement of a partner's product beside
> editorial content, and the surface labels it _Reklam_.
>
> **What is bounded, and it is everything §20 already bounds.** The
> complementary region is _named_ rather than left implicit; a placement may not
> occupy or influence a position in Results; it reads nothing about the person,
> the Discovery path, the Comparison Set or the Decision Chat; it changes
> nothing about eligibility, matching or a Listing Card; it is labelled in the
> person's own language and legibly without colour; and it is absent by default.
> The platform still does not sell, price, moderate or report advertising —
> §20.5's exclusion of impression, click, revenue and fill-rate reporting
> applies to this region unchanged, which is why the implementation records no
> click.
>
> **What is new and is a real addition:** the position. §20.1 places advertising
> in the Offering Presentation _below the seller list_; the Owner's placement is
> directly under the actions, which is above it. §20.6's existing scenarios are
> unchanged and two are added.
