...
- **Version:** 2.1
- **Supersedes:** Frozen v2.0, preserved unchanged at `docs/traceability-v2.0-superseded.md`
...
| This superseding revision                                | **Frozen v2.1**                   | Complete. Owner approval and, separately, Owner freeze taken 2026-09-04. This document is the baseline; v2.0 is preserved at `docs/traceability-v2.0-superseded.md`                                          |
| Increments `I76`, `I77`, `I78` — feed intake, retention sweeps, the third eligibility input, Affiliate CTR | **Built and PRD-owned; not yet traced here**  | A v2.2 revision. `PRD-0001` v4.1 §7.2 owns the Intake Availability input and `PRD-0006` v2.5 §11.2 the Affiliate Handoff Rate, both Frozen 2026-09-03; no Feature ID, Story or §5A row has been written for them yet. They are named here rather than folded into this revision, because the Owner approved v2.1's scope and quietly widening it would make the approval mean something he did not read |
